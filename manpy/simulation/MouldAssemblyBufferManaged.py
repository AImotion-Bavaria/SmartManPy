    ...
    def getEntity(self):
        ...
        try:
            ...
            if activeEntity.componentType == "Basic":
                ...
                for secondary in [
                    x
                    for x in activeEntity.order.secondaryComponentsList
                    if activeEntity.order.basicsEnded
                ]:
                    if (
                        secondary.currentStation.__class__.__name__
            ...
            for entity in (
                activeEntity.order.basicComponentsList
    ...
    def haveToDispose(self, callerObject=None):
        ...
        if len(thecaller.getActiveObjectQueue()) == 0:
            if activeEntity.type == "Mould":
                ...
                return (
                    thecaller.isInRouteOf(activeObject)
