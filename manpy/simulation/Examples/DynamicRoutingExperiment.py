...
M3 = Machine("M3", "Machine3", processingTime={"Normal": {"mean": 15.3, "stdev": 0.1, "min": 0.1, "max": 0.4}})
M1 = Machine("M1", "Machine1", processingTime={"Normal": {"mean": 0.2, "stdev": 0.1, "min": 0.08, "max": 0.34}},
             dynamicRouting=dynRouting, successorCandidates=[M2, M3])
E1 = Exit("E1", "Exit1")
...
# M2.defineRouting([M1], [E1])
# E1.defineRouting([M2, M3])
#
# M3.defineRouting([M1], [E1])
