...
class Machine_control2(Machine):
    ...
    def condition(self):
        ...
        if any(activeEntity.labels):
            ...
            influence = [True, False, False, True, False, True, False, False, False]
            for idx, feature in enumerate(activeEntity.features):
...
# TODO currently only features that are generated by a statecontroller influence the overall label of an entity!
