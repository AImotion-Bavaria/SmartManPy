...
ManPy was originally developed as part of the FP7 DREAM project: https://www.manpy-simulation.org/, which was released under the MIT license

We performed the following modifications/additions:
...
* Added complex features to machines:
    ...
    - Timeseries that can be interpolated from a couple of real-worls data points
